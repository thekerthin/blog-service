...
export class InitialScript1568255496864 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('CREATE TABLE "blogs" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "title" character varying(100) NOT NULL, "description" character varying(350), "content" text NOT NULL, "owner_id" character varying(36) NOT NULL, "is_public" boolean NOT NULL DEFAULT false, "user_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_e113335f11c926da929a625f118" PRIMARY KEY ("id"))');
        ...
        await queryRunner.query('ALTER TABLE "blogs" ADD CONSTRAINT "FK_c699ca1c62cd9707420e4acab90" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION');
    }
